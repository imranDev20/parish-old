    ...
    <Drawer width={400} open={open} className="p-6">
      ...
      <div className="flex justify-center gap-3 text-[12px]">
        <div className="relative group">
          ...
          <div className="absolute z-[99] right-[-117px] mt-0 w-60	bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible">
        ...
        <div className="relative group">
          ...
          <div className="absolute z-[99] right-[-52px] mt-0 w-60	 bg-white rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible">
